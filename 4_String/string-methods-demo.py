...
#2- c içindeki sadikturan bilgisi haricindeki her karakteri silin.
...
#split metodu ile string ifadeyi her boşluk karakterinden ayırıp bir listeye çevirmiş oluruz ve 
#her bir liste elemanına indeks numarası ile ulaşabiliriz.
